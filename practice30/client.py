    ...
    def login(self,event):
        ...
        try:
            ...
            if response == b'UserName Empty':
                ...
                self.Close()
                ChatFrame(None,2,title='403 Chat Client',size=(500,400))
        except Exception:
...
class ChatFrame(wx.Frame):
    ...
    def __init__(self,parent,id,title,size):
        #初始化，添加控件并绑定
        wx.Frame.__init(self,parent,id,title)
        self.SetSize(size)
        self.Center()
        ...
        self.closeButton = wx.Button(self,lable="Close",pos=(436,320),size=(58,25))
        #发送按钮绑定发送消息方法
